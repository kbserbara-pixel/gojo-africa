...
export const translations: Record<Locale, Dict> = {
  en: {
    ...
    loginPage: {
      ...
      identifierPlaceholder: "you@example.com or +251 9XX XXX XXX",
      password: "Password",
      submit: "Log in",
      submitting: "Logging in...",
      error: "Could not log in -- check your email/phone and password, and that the backend is running.",
    ...
    registerPage: {
      ...
      contactHint: "Provide an email, a phone number, or both.",
      contactRequiredError: "Enter an email or a phone number.",
      password: "Password",
      roleLabel: "I am a...",
      roles: {
        renter: "Renter / Buyer",
      ...
      error: "Could not create your account -- that email or phone number may already be registered, or the backend isn't running.",
      genericError: "Something went wrong.",
    ...
    postListingPage: {
      ...
      contactPhonePlaceholder: "+251 9XX XXX XXX",
      locationLabel: "Location",
      locationHint: "Click on the map to drop a pin at the property's location, or use your current location.",
      useMyLocation: "Use my current location",
      locating: "Finding you...",
      photosLabel: "Photos",
      photosHint: "Add a few photos of the property.",
      ...
      submittedBody: '"{title}" is now live on the marketplace.',
  ...
  am: {
    ...
    loginPage: {
      title: "ይግቡ",
      identifier: "ኢሜይል ወይም ስልክ ቁጥር",
      identifierPlaceholder: "you@example.com ወይም +251 9XX XXX XXX",
      password: "የመግቢያ ቁጥር",
      submit: "ይግቡ",
      submitting: "በመግባት ላይ...",
      error: "መግባት አልተቻለም። ኢሜይልዎን/ስልክ ቁጥርዎንና የመግቢያ ቁጥርዎን በትክክል ያስገቡ፣ አገልጋዩም እየሰራ መሆኑን ያረጋግጡ።",
    ...
    registerPage: {
      ...
      phone: "የስልክ ቁጥር (አማራጭ)",
      email: "ኢሜይል (አማራጭ)",
      contactHint: "ኢሜይል ወይም ስልክ ቁጥር ያስገቡ (ቢያንስ አንዱን)።",
      contactRequiredError: "እባክዎ ኢሜይል ወይም ስልክ ቁጥር ያስገቡ።",
      password: "የመግቢያ ቁጥር",
      roleLabel: "እኔ...",
      roles: {
        renter: "ተከራይ ወይም ገዢ",
      ...
      error: "መለያ መክፈት አልተቻለም። ይህ ኢሜይል ወይም ስልክ ቁጥር ቀደም ሲል ተመዝግቦ ሊሆን ይችላል፣ ወይም አገልጋዩ እየሰራ ላይሆን ይችላል።",
      genericError: "የሆነ ችግር ተከስቷል።",
    ...
    postListingPage: {
      ...
      contactPhoneLabel: "ለመገናኛ የስልክ ቁጥር",
      contactPhonePlaceholder: "+251 9XX XXX XXX",
      locationLabel: "አካባቢ",
      locationHint: "ንብረቱ የሚገኝበትን ቦታ ለማመልከት ካርታው ላይ ይጫኑ፣ ወይም የአሁኑን አካባቢዎ ይጠቀሙ።",
      useMyLocation: "የአሁኑን አካባቢዬ ይጠቀሙ",
      locating: "አካባቢዎን በመፈለግ ላይ...",
      photosLabel: "ፎቶዎች",
      photosHint: "የንብረቱን ጥቂት ፎቶዎች ያክሉ።",
      uploadingPhotos: "ፎቶዎችን በመላክ ላይ...",
      submit: "ንብረት ያስገቡ",
      submitting: "በማስገባት ላይ...",
      error: "ንብረቱን ማስገባት አልተቻለም። ያስገቡት መረጃ ትክክል መሆኑን እና አገልጋዩ እየሰራ መሆኑን ያረጋግጡ።",
      genericError: "የሆነ ችግር ተከስቷል።",
      submittedTitle: "ንብረቱ በሰላም ገብቷል",
      submittedBody: "“{title}” አሁን በገበያው ላይ ይታያል።",
